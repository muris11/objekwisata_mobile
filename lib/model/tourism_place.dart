...
var tourismPlaceList = [
  TourismPlace(
    ...
    imageAsset: 'android/images/farm-house.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    imageAsset: 'android/images/bosscha.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    openTime: '24 hours',
    ticketPrice: 'Free',
    imageAsset: 'android/images/jalan-asia-afrika.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    ticketPrice: 'Rp 3000',
    imageAsset: 'android/images/stone-garden.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    openTime: '24 hours',
    ticketPrice: 'Free',
    imageAsset: 'android/images/taman-film.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    ticketPrice: 'Rp 3000',
    imageAsset: 'android/images/museum-geologi.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    ticketPrice: 'Rp 20000',
    imageAsset: 'android/images/floating-market.png',
    imageUrls: [
  ...
  TourismPlace(
    ...
    imageAsset: 'android/images/kawah-putih.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    openTime: '24 hours',
    ticketPrice: 'Rp 20000',
    imageAsset: 'android/images/ranca-upas.jpg',
    imageUrls: [
